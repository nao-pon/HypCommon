...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
    ...
    if ($xoopsConfig['closesite'] == 1) {
        ...
        if (!$allowed) {
            ...
            $xoopsTpl->assign(array('xoops_sitename' => htmlspecialchars($xoopsConfig['sitename'], ENT_COMPAT, _CHARSET), 'xoops_themecss' => xoops_getcss(), 'xoops_imageurl' => XOOPS_THEME_URL.'/'.$xoopsConfig['theme_set'].'/', 'lang_login' => _LOGIN, 'lang_username' => $xoopsConfig['emaillogin'] ? _USERNAME_EMAIL : _USERNAME, 'lang_password' => _PASSWORD, 'lang_siteclosemsg' => $xoopsConfig['closesite_text']));
